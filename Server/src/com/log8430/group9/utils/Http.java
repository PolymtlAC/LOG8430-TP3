...
public class Http {
	...
	public static String get(String targetURL, String urlParameters, API api) {
		...
		try {
			...
			if(api != null && api.getName() == "dropbox") {
				connection.setRequestProperty ("Authorization", "Bearer "+((APIDropbox) api).getToken());
			}
	...
	public static String post(String targetURL, String urlParameters, API api) {
		HttpURLConnection connection = null;  
		try {
			//Create connection
