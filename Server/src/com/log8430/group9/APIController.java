...
public class APIController {
	...
	@RequestMapping("/auth")
    public String tree(@RequestParam(value="api", defaultValue="server") String apiName) {
    ...
    public String dropboxCode(@RequestParam(value="code", defaultValue="server") String code) {
		String result = Http.post("https://api.dropboxapi.com/1/oauth2/token", "grant_type=authorization_code"
